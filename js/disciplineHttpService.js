angular.module('application').service('disciplineService', function($http){
	...
	return{
		...
		getRegexp: function(fieldName){
			return regexps[fieldName];
		},

		getExceptionMessage: function(exceptionName){
			exceptionParams = exceptionName.split(".");

			return exceptionMessages[exceptionParams[0]][exceptionParams[1]];
		}
	};
});